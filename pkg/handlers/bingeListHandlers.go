...
func CreateNewBingeList(c *config.Repository) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		blc := db.GetCollection(c.Config.MongoClient, "bingelists")
		_, err = blc.InsertOne(context.TODO(), newList)
		if err != nil {
...
func DeleteBingeList(c *config.Repository) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var resp responses.Response
		...
		result := bson.M{}
		blc := db.GetCollection(c.Config.MongoClient, "bingelists")
		err = blc.FindOneAndDelete(context.TODO(), filter).Decode(&result)
		if err != nil {
...
func GetMinifiedBingeLists(c *config.Repository) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var resp responses.Response
		owner := r.Context().Value("userId").(string)
		miniLists, err := services.BuildMinifiedBingeSlicesByOwner(owner, c.Config.MongoClient)
		if err != nil {
...
func GetBingeList(c *config.Repository) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var resp responses.Response
		owner := r.Context().Value("userId").(string)
		...
		blc := db.GetCollection(c.Config.MongoClient, "bingelists")
		err = blc.FindOne(context.TODO(), filter).Decode(&list)
		if err != nil {
...
func GetBingeLists(c *config.Repository) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var resp responses.Response
		owner := r.Context().Value("userId").(string)
		...
		blc := db.GetCollection(c.Config.MongoClient, "bingelists")
		cursor, err := blc.Find(context.TODO(), filter)
...
func AddToBingeList(c *config.Repository) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var resp responses.Response
		owner := r.Context().Value("userId").(string)
		lIdStr := r.URL.Query().Get("id")
		...
		alreadyExists := services.AlreadyExists("bingelists", owner, mediaItem.MediaId, mediaItem.Type, c.Config.MongoClient, listId)
		if alreadyExists {
		...
		blc := db.GetCollection(c.Config.MongoClient, "bingelists")
		result, err = blc.UpdateOne(context.TODO(), filter, update)
		if err != nil {
...
func RemoveFromBingeList(c *config.Repository) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var resp responses.Response
		owner := r.Context().Value("userId").(string)
		lIdStr := r.URL.Query().Get("id")
		...
		alreadyExists := services.AlreadyExists("bingelists", owner, mediaId, mediaType, c.Config.MongoClient, listId)
		if !alreadyExists {
